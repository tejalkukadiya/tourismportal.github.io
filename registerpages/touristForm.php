...
<div class="container">
	<div style="margin:auto;display: block; padding:0 400px;">
	...
	<div class="row" >
			<div class="form-group col-md-12">
				<div class="form-group name">
					<label for="username">Username</label>
		  		  	...
		  		  	<input type="password" required="required" class="form-control" id="confirm" name="confirm">
		<!--<script type="text/javascript">
            ...
            return true;
		  		  	...
		  		  	<input type="textarea" required="required" class="form-control" id="address" name="address" cols="200" rows="5">

		  		  	<label for="email">E-mail</label>
		  		  	<input type="email" class="form-control" required="required" id="email" name="email">
		  		  	<label for="phone">Phone</label>
		  		  	<input type="text" class="form-control" id="phone" name="phone" required="required"><br>
