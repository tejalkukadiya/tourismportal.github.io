<?php
  ...
  $_SESSION['currentUrl']="restaurant-form.php";
...
?>
	<div class="container">
		<form method="post" action="restaurant-entry.php" class="registerform " enctype="multipart/form-data" >
			
			<div class="row">
				<div class="form-group col-md-6">
					<div class="form-group">
						<label for="gresName">Restaurant Name</label>
			  		  	<input type="text" class="form-control"  required="required" id="resName" name="resName">
			  		</div>
					<div class="form-group">
				...
				<div class="form-group">
					<label for="resWebsite">Restaturant Website</label>
		  		  	<input type="Website" class="form-control" required="required" id="resWebsite" size="10" name="resWebsite">
				</div>	
				<div class="form-group">
			...
			<div class="form-group">
					<label for="cuisine">Cuisine</label>
		  		  	<input type="text" class="form-control"  required="required" id="cuisine" name="cuisine">
		  		</div>
			<div class="form-group from-inline">
	    		<label for="food">Food Type</label>
				<select class="selectpicker form-control" name="food" data-placeholder="" data-live-search="true">
				  		<option disabled selected value> -- select a food-type -- </option>
				  		<option value="Vegetarion">Vegetarion</option>
				  		<option value="Non-Vegetarion">Non-Vegetarion</option>
